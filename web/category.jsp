                ...
                <div class='row'>
                                    ...
                                    <form action="search" method="POST" >
                                        ...
                                        <div class="sidebar-widget-body m-t-10">
                                            <table style="font-size: 120%">
                                                <tbody>
                                                    <tr>
                                                        <td><input type="checkbox" name="price" value="36" style="margin: 0 20px 5px 0"/></td>
                                                        <td>300 - 600 $</td>
                                                    </tr>
                                                    <tr>
                                                        <td><input type="checkbox" name="price" value="68" style="margin: 0 20px 5px 0"/></td>
                                                        <td>600 - 800 $</td>
                                                    </tr>
                                                    <tr>
                                                        <td><input type="checkbox" name="price" value="810" style="margin: 0 20px 5px 0"/></td>
                                                        <td>800 - 1000 $</td>
                                                    </tr>
                                                    <tr>
                                                        <td><input type="checkbox" name="price" value="1012" style="margin: 0 20px 5px 0"/></td>
                                                        <td>1000 - 1200 $</td>
                                                    </tr>
                                                    <tr>
                                                        <td><input type="checkbox" name="price" value="1216" style="margin: 0 20px 5px 0"/></td>
                                                        <td>1200 - 1600 $</td>
                                                    </tr>
                                                </tbody>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9 rht-col"> 
                        ...
                        <div id="category" class="category-carousel hidden-xs">
                            <div class="item">
                                <div class="image"> <img src="assets/images/banners/home-banner4.jpg" alt="" class="img-responsive" style="width: 200%"> </div>
                                <!-- /.container-fluid --> 
                            </div>
                        </div>
                                            ...
                                            <div class="fld inline">
                                                <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                                                    ...
                                                    <ul role="menu" class="dropdown-menu">
                                                        <li role="presentation"><a href="search?order=low&cat=${name} ">Price:Lowest first</a></li>
                                                        <li role="presentation"><a href="search?order=high&cat=${name} ">Price:Highest first</a></li>
                                                        <li role="presentation"><a href="search?order=name&cat=${name} ">Product Name:A to Z</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <!-- /.fld --> 
                                ...
                                <div class="col col-sm-6 col-md-4 col-xs-6 col-lg-4 text-right">
                                    <div class="pagination-container">
                                        <ul class="list-inline">
                                            ...
                                            <c:if test="${i > 1}">
                                                <li class="prev"><a href="category?index=${i-1}"><i class="fa fa-angle-left"></i></a></li>
                                                    </c:if>
                                            ...
                                            <c:forEach var="p" begin="${startPage}" end="${endPage}">
                                                <c:if test="${i == p}">
                                                    <li style=" font-weight: bolder;font-size: larger">

                                                        <a href="category?index=${p}" class="active" >${p}</a>
                                                    </li>
                                                </c:if>
                                                <c:if test="${i != p}">
                                                    <li>
                                                        <a href="category?index=${p}">${p}</a>
                                                    </li>
                                                </c:if>
                                            </c:forEach>
                                            ...
                                            <c:if test="${i < Nopage}">
                                                <li class="next"><a href="category?index=${i+1}"><i class="fa fa-angle-right"></i></a></li>
                                                    </c:if>  
                                        </ul>
                                        <!-- /.list-inline --> 
                                    </div>
                            ...
                            <div id="myTabContent" class="tab-content category-list">
                                <div class="tab-pane active " id="grid-container">
                                    <div class="category-product">
                                        <div class="row">
                                            <c:forEach items="${sessionScope.listPC}" var="s" >
                                                                ...
                                                                <div class="cart clearfix animate-effect">
                                                                    <div class="action">
                                                                        <ul class="list-unstyled">
                                                                            <li class="add-cart-button btn-group" style="display: flex;justify-content: center">
                                                        ...
                                                        <div class="row product-list-row">
                                                            ...
                                                            <div class="col col-sm-9 col-lg-9">
                                                                <div class="product-info">
                                                                    <h3 class="name"><a href="detail?pid=${s.productID}">${s.name}</a></h3>
                                                                    <div class="rating rateit-small"></div>
                                                                    <div class="product-price"> <span class="price"> $ ${s.price} </span> <span class="price-before-discount"></span> </div>
                                                                    <!-- /.product-price -->
