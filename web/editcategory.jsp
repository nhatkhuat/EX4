<%-- 
    ...
    Created on : Jun 30, 2024, 1:47:09 PM
    Author     : nhatk
--%>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="catname" value="${name}" placeholder="Enter category name"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>Description</label>
                                            <c:set value="${requestScope.description}" var="des"/>
                                            <textarea class="form-control" name="description" placeholder="Enter description here">${des}
                                            </textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
